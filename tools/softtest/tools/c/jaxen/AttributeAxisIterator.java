 ...
 */
package softtest.tools.c.jaxen;
...
public class AttributeAxisIterator implements Iterator
{
	...
	protected boolean isAttributeAccessor(Method method)
	{
		...
		return (isSelfOrSuperClass(method.getReturnType(),CType.class)||Integer.TYPE == method.getReturnType() || Boolean.TYPE == method.getReturnType() || String.class == method.getReturnType())
