...
public class Test_DAB {
    ...
    private static final String fsmPath = "softtest/rules/gcc/rule/HW_6_1_DAB-0.1.xml";

    FSMAnalysisVisitor fsmAnalysis;

    private FSMControlFlowData cfData;

    public Test_DAB(String source, String compiletype, String result) {
        this.source = source;
