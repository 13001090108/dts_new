...
public class HW_6_1_SVL {
    ...
    private static final String fsmPath = "softtest/rules/gcc/rule/HW_6_1_SVL-0.1.xml";

    FSMAnalysisVisitor fsmAnalysis;

    private FSMControlFlowData cfData;

    public HW_6_1_SVL(String source, String compiletype, String result) {
        this.source = source;
