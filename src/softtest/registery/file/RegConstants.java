...
public class RegConstants
{
	...
	public final static String LICENSE_FILE_NAME_0 = "license_GCC.dts";

	public final static String LICENSE_FILE_PATH_1 = "..\\set";

	public final static String LICENSE_FILE_NAME_1 = "q3tvbc.dat";

	public final static String LICENSE_REG_KEY = "Software\\DTS";

	public final static String LICENSE_REG_VALUE = "regInfo_GCC";
