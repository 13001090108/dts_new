...
public class IntegerInterval implements Comparable<IntegerInterval>,Cloneable {
	...
	public static IntegerInterval add(IntegerInterval x, IntegerInterval y) {
		DoubleInterval a=new DoubleInterval(x.getDoubleMin(),x.getDoubleMax()),b=new DoubleInterval(y.getDoubleMin(),y.getDoubleMax());
		DoubleInterval c=DoubleInterval.add(a, b);
	...
	public static IntegerInterval uminus(IntegerInterval x) {
		DoubleInterval a=new DoubleInterval(x.getDoubleMin(),x.getDoubleMax());
