...
public class FSMState extends FSMElement implements Comparable<FSMState> {
	...
	public void loadXML(Node n) {
		if (n.getAttributes().getNamedItem("isStartState") != null
				&& n.getAttributes().getNamedItem("isStartState")
		...
		if (n.getAttributes().getNamedItem("isErrorState") != null
				&& n.getAttributes().getNamedItem("isErrorState")
						.getNodeValue().equals("true")) {
			iserror = true;
		} else {
			iserror = false;
		...
		if (n.getAttributes().getNamedItem("isFinalState") != null
				&& n.getAttributes().getNamedItem("isFinalState")
						.getNodeValue().equals("true")) {
			isfinal = true;
		} else {
			isfinal = false;
